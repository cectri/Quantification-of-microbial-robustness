...
summary <- readxl::read_excel("~/Box/PhD/Experimental_Data/R/ACS_scripts/plate_legend_ACS.xlsx")
...
data <- readxl::read_excel("~/Box/PhD/Experimental_Data/Robustness in 96-well plate/ACS_data/CENPK7D/CENPK7D_1.xlsx", sheet = "GV") %>%
...
```{r}
#load data
strain_summary <- readxl::read_excel("~/Box/PhD/Experimental_Data/Robustness in 96-well plate/ACS_data/CENPK7D/CENPK7D_summary.xlsx")
summary_dilutions <- readxl::read_excel("~/Box/PhD/Experimental_Data/R/ACS_scripts/summary_dilutions.xlsx")
sugar_initial_concentration <- readxl::read_excel("~/Box/PhD/Experimental_Data/R/ACS_scripts/sugar_initial_concentration.xlsx")
```
